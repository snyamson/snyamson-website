...
export const seedProjectDetails: ProjectDetail[] = [
  {
    _id: "seed-project-warc-bi",
    title: "Business intelligence platform",
    slug: "warc-business-intelligence-platform",
    ...
    results: [
      { value: "6", label: "Source systems in one governed model" },
      { value: "Bronze → Gold", label: "Medallion layers enforced in Power Query" },
      { value: "2", label: "Countries reporting off the same definitions" },
      {
        value: "dev → prod",
        label: "Six workspaces promoted by pipeline, not by hand",
      },
    ],
  },
  {
